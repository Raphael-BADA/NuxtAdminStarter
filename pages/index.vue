<template>
  <div>
    <body>
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-6">
                          ...
                          >
                            <i
                              class="fe-heart font-22 avatar-title text-primary"
                            ></i>
                          </div>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-6">
                          ...
                          >
                            <i
                              class="fe-shopping-cart font-22 avatar-title text-success"
                            ></i>
                          </div>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-6">
                          ...
                          >
                            <i
                              class="fe-bar-chart-line- font-22 avatar-title text-info"
                            ></i>
                          </div>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-6">
                          ...
                          >
                            <i
                              class="fe-eye font-22 avatar-title text-warning"
                            ></i>
                          </div>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="card-body">
                      ...
                      <div class="widget-chart text-center" dir="ltr">
                        ...
                        <p class="text-muted w-75 mx-auto sp-line-2">
                          ...
                          in the meat of your page content.
                        </p>
                        ...
                        >
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <i
                                  class="mdi mdi-currency-btc text-primary"
                                ></i>
                                BTC
                              </td>
                            ...
                            <tr>
                              ...
                              <td>
                                <i
                                  class="mdi mdi-currency-eth text-primary"
                                ></i>
                                ETH
                              </td>
                            ...
                            <tr>
                              ...
                              <td>
                                <i
                                  class="mdi mdi-currency-eur text-primary"
                                ></i>
                                EUR
                              </td>
                            ...
                            <tr>
                              ...
                              <td>
                                <i
                                  class="mdi mdi-currency-cny text-primary"
                                ></i>
                                CNY
                              </td>
      ...
      <!-- Theme Settings -->
      <div
        class="offcanvas offcanvas-end right-bar"
        tabindex="-1"
      ...
      >
        <div class="d-flex align-items-center w-100 p-0 offcanvas-header">
          <!-- Nav tabs -->
          <ul
            class="nav nav-tabs nav-bordered nav-justified w-100"
            role="tablist"
          >
            <li class="nav-item">
              <a
            ...
            <li class="nav-item">
              ...
              >
                <i
                  class="mdi mdi-format-list-checkbox d-block font-22 my-1"
                ></i>
              </a>
            </li>
            <li class="nav-item">
              ...
              <div class="d-flex flex-column gap-2">
                <div class="form-check form-switch">
                  <input
                    ...
                    value="default"
                  />
                  <label class="form-check-label" for="layout-width-default"
                    >Fluid (Default)</label
                  >
                </div>
                ...
                <div class="d-flex flex-column gap-2">
                  <div class="form-check form-switch">
                    <input
                      ...
                      value="default"
                    />
                    <label class="form-check-label" for="layout-mode-default"
                      >Default</label
                    >
                  </div>
                  ...
                  <div id="layout-detached">
                    <div class="form-check form-switch">
                      <input
                        ...
                        value="detached"
                      />
                      <label class="form-check-label" for="layout-mode-detached"
                        >Detached</label
                      >
                    </div>
                  </div>
              ...
              <div class="d-flex flex-column gap-2">
                ...
                <div class="form-check form-switch">
                  <input
                    ...
                    value="brand"
                  />
                  <label class="form-check-label" for="topbar-color-brand"
                    >Brand</label
                  >
                </div>
              </div>
                ...
                <div class="d-flex flex-column gap-2">
                  ...
                  <div class="form-check form-switch">
                    <input
                      ...
                      value="brand"
                    />
                    <label class="form-check-label" for="leftbar-color-brand"
                      >Brand</label
                    >
                  </div>
                  <div class="form-check form-switch">
                    <input
                      ...
                      value="gradient"
                    />
                    <label class="form-check-label" for="leftbar-color-gradient"
                      >Gradient</label
                    >
                  </div>
                </div>
                ...
                <div class="d-flex flex-column gap-2">
                  <div class="form-check form-switch">
                    ...
                    <label
                      ...
                      for="twocolumn-menu-color-light"
                      >Light</label
                    >
                  </div>
                  ...
                  <div class="form-check form-switch">
                    ...
                    <label
                      class="form-check-label"
                      for="twocolumn-menu-color-brand"
                      >Brand</label
                    >
                  </div>
                  <div class="form-check form-switch">
                    ...
                    <label
                      class="form-check-label"
                      for="twocolumn-menu-color-gradient"
                      >Gradient</label
                    >
                  </div>
                </div>
                ...
                <div class="d-flex flex-column gap-2">
                  <div class="form-check form-switch">
                    <input
                      ...
                      value="default"
                    />
                    <label class="form-check-label" for="menu-icon-default"
                      >Default</label
                    >
                  </div>
                  ...
                  <div class="form-check form-switch">
                    <input
                      ...
                      value="twotones"
                    />
                    <label class="form-check-label" for="menu-icon-twotone"
                      >Twotone</label
                    >
                  </div>
                </div>
        ...
        <div class="offcanvas-footer border-top py-2 px-2 text-center">
          <div class="d-flex gap-2">
            ...
            <a
              ...
              target="_blank"
              ><i class="mdi mdi-basket me-1"></i> Buy</a
            >
          </div>
        </div>
      </div>
